...
function resizeArea(){
	...
	if(wide==800&&high==1280||wide==600&&high==960){
		a=$(window).innerWidth();
		b=$(window).innerHeight();
	}
...
items.forEach(function(j){$("#"+j.name).css("top",j.rect.t+"px");
...
function seek(a){
			...
			{
				if(items[i]["name"]==a){return items[i]}
			}
			return null
		};
